...
loadSprite("space", "sprites/space.jpg");
loadSprite("ship", "sprites/ship.png");
loadSprite("bullet", "sprites/bullet.png");
loadSprite("enemy", "sprites/enemy1.png");
loadSprite("command-ship", "sprites/enemy-command-ship.png");
loadSprite("fireball", "sprites/clipart261222.png");

loadSound("laser", "sounds/laser.wav");
loadSound("explosion", "sounds/explosion.wav");
loadSound("explosion2", "sounds/implosion.wav");
